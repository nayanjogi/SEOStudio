...
function file_get_html($url, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
{
	...
	if($path) {
		if(file_exists($path . "data/engine.etr")) {
			$engine = file_get_contents($path . "data/engine.etr");
			
			$url = str_replace("https://www.google.com/", "https://www.google.$engine/", $url);
			$url = str_replace("https://", "http://", $url);
			$url = str_replace("/search?q=", "/search?filter=0&q=", $url);
		}
	}
	...
	if(strpos($data, "No results found for") !== false) {
		$data = str_replace("<div id=\"resultStats\">", "<div id='resultStats'>0</div><div id=\"resultStatsOld\">", $data);
		$data = str_replace("<div class=\"sd\" id=\"resultStats\">", "<div id='resultStats'>0</div><div id=\"resultStatsOld\">", $data);
