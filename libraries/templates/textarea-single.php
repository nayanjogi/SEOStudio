		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-8">
					...
					<h3><?=$lang->translate($application->getMemory("Description"), "header");?></h3>
					<hr />
					...
					<form action="" method="POST" style="padding-top: 10px;">
						...
						<div class="input-group">
							<textarea style="height: 150px;" name="<?=$parameters[0];?>" class="form-control input-block placeholder">Apples
Oranges
Bananas</textarea>
						
							<span class="input-group-btn">
								<button style="height: 150px;" type="submit" class="btn btn-success btn-lg"><?=$lang->translate("Continue", "button");?></button>
							</span>
						</div>
					</form>
				</div>
