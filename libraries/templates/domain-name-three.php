		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-8">
					...
					<h3><?=$lang->translate("Enter at least two websites to continue", "header");?></h3>
					<hr />

					<form action="" method="POST" style="padding-top: 10px;">
						<input type="hidden" name="doFormPostback" value="<?=md5($title);?>">
						
						<input type="text" name="<?=$parameters[0];?>" class="form-control input-lg input-block placeholder pb" value="http://www.example.com/">
						<input type="text" name="<?=$parameters[1];?>" class="form-control input-lg input-block placeholder pb" value="http://www.example.com/">
						
						<div class="input-group">
							<input type="text" name="<?=$parameters[2];?>" class="form-control input-lg input-block placeholder" value="http://www.example.com/">
