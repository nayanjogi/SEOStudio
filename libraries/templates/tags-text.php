		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-8">
					...
					<h3><?=$lang->translate("Enter a few tags separated by commas to continue.", "header");?></h3>
					<hr />
					...
					<form action="" method="POST" style="padding-top: 10px;">
						...
						<div class="input-group">
							<input type="text" name="<?=$parameters[0];?>" class="form-control input-lg input-block placeholder" value="apples, bananas, oranges">
