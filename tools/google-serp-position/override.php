		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-8">
					...
					<h3><?=$lang->translate("Enter a website to continue", "header");?></h3>
					<hr />

					<form action="" method="POST" style="padding-top: 10px;">
						<input type="hidden" name="doFormPostback" value="<?=md5($title);?>">
						
						<input type="text" name="website" class="form-control input-lg input-block placeholder pb" value="http://www.example.com/">
						<div class="input-group">
							<input type="text" name="search" class="form-control input-lg input-block placeholder" value="search phrase">
